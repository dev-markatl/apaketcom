...
<div >
    ...
    <form class="form-horizontal" align="center" name="faturalistesi" style=" display:inline ;clear:both; " id="faturalistesi" action="fatura-faturatakip" >
        <div class="form-group col-md-12 filter"  align="left" >
            ...
            <div class="col-md-4 btnDurumFiltreDiv" align="right" >
                ...
                <?php  $dd->BtnDurum("durum",4,"FaturaTakip","S",null,"background-color:#b69fff");?>
        ...
        <div class="form-group col-md-12 filter" align="left"  >
            ...
            <?php $dd->Make($ddRobotlar,"robotlar","robotlar","FaturaTakip");?>            
        </div>
        ...
        <?php
            foreach($takipler as $takip)
            {
                ...
                <tr id='tr_$takip->id' name='aa' style='background-color:$renk'  >
                    ...
                    <td  align='center' onClick='satirAc($takip->id)' >$takip->kurumAdi</td>
                ...
                <tr onClick='satirKapa($takip->id)' >
                    <td style='text-align:left; color:red;' colspan='12'>
    ...
    <?php
        ...
        { 
            ...
            echo "
            <a 
                href='fatura-faturatakip?sayfa=$i&$filtreler'
...
{
    if($("#durumKaydet")[0].value==3 || $("#durumKaydet")[0].value==2 )
